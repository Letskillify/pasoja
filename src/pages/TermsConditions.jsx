    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 md:py-20 space-y-12">
        ...
        <section className="space-y-4 border-t border-white/[0.08] pt-8">
          ...
          <p className="text-xs md:text-sm text-white/60 leading-relaxed">
            These Terms shall be governed by and construed in accordance with the laws of India. For any inquiries regarding our terms, please contact our support team at <span className="text-white">support@pasoja.com</span>.
          </p>
        </section>
      </div>
    </div>
